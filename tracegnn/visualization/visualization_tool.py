...
class WebViewerUtil:
    def __init__(self,
        ...
        logger.info(f"[WebViewerUtil] Loading self.result from: D:/GraduationProject/GTrace/tracegnn/visualization/sample_cases/model_dat/case_{case_idx}.pkl")
        self.result = pickle.loads(snappy.decompress(open(f'D:/GraduationProject/GTrace/tracegnn/visualization/sample_cases/model_dat/case_{case_idx}.pkl', 'rb').read()))
        logger.info("[WebViewerUtil] Loading finished.")

        # Load id_manager
        self.id_manager = TraceGraphIDManager('D:/GraduationProject/GTrace/tracegnn/visualization/sample_cases/id_manager')
        self.nll_info = json.load(open('D:/GraduationProject/GTrace/tracegnn/visualization/sample_cases/model_dat/nll_info.json', 'rt'))
