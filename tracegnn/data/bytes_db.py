...
class BytesSqliteDB(BytesDB):
    ...
    def __init__(self, path: str, write: bool = False, table_name: str = 'data',
        ...
        # self.conn = sqlite3.connect(os.path.join(r'/mnt/d/GraduationProject/GTrace', self.path, file_name))
        self.conn = sqlite3.connect(os.path.join(r'D:/GraduationProject/GTrace', self.path, file_name))
